...
description: Build with the Gemini Live API — low-latency real-time voice, video, and text interactions over WebSockets. Use when implementing bidirectional audio/video streaming, transcription, VAD, function calling, session resumption, or ephemeral tokens with `gemini-3.1-flash-live-preview`, or migrating from deprecated 2.x live models. Covers Python (`google-genai`) and JS/TS (`@google/genai`) SDKs.
---
